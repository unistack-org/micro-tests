...
require (
	...
	github.com/unistack-org/micro-client-grpc/v3 v3.3.2
	...
	github.com/unistack-org/micro-server-grpc/v3 v3.3.4
	github.com/unistack-org/micro-server-http/v3 v3.3.12
