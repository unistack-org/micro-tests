...
replace go.unistack.org/micro-client-grpc/v3 => ../micro-client-grpc

replace go.unistack.org/micro-client-drpc/v3 => ../micro-client-drpc
...
require (
	...
	go.unistack.org/micro-client-drpc/v3 v3.0.0-00010101000000-000000000000
