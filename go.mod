...
require (
	...
	github.com/unistack-org/micro-client-http/v3 v3.1.1
	...
	github.com/unistack-org/micro-config-env/v3 v3.1.2
	github.com/unistack-org/micro-config-vault/v3 v3.1.1
