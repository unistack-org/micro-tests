...
import (
	...
	rpc "go.unistack.org/micro-api-handler-rpc/v5"
	rregister "go.unistack.org/micro-api-router-register/v5"
	rstatic "go.unistack.org/micro-api-router-static/v5"
	gcli "go.unistack.org/micro-client-grpc/v5"
	...
	gsrv "go.unistack.org/micro-server-grpc/v5"
	gpb "go.unistack.org/micro-tests/server/grpc/gproto"
	pb "go.unistack.org/micro-tests/server/grpc/proto"
	"go.unistack.org/micro/v5/api"
	"go.unistack.org/micro/v5/api/handler"
	"go.unistack.org/micro/v5/api/router"
	...
	rt "go.unistack.org/micro/v5/router"
